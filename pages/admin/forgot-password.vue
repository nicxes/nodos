<template>
  <main class="h-screen flex items-center justify-center transition duration-150 ease-in-out" :class="form.success ? 'bg-success' : 'bg-transparent'">
    <div class="container mx-auto flex justify-center">
      <form
        v-if="!form.success"
        class="bg-neutral-50 rounded-3xl max-w-[461px] py-10 px-16 transition duration-150 ease-in-out w-full"
      ...
      <div v-else class="flex justify-center items-center flex-col">
        ...
        <h1 class="font-body text-3xl text-white mb-4 font-semibold mb-4">
          ¡Listo!
        </h1>
        <p class="font-display text-lg text-white max-w-[286px] text-center">
          Enviamos un mail para que cambies tu contraseña.
        </p>
      </div>
    </div>
  </main>
