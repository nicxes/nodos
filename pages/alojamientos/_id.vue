<template>
  <section class="pb-12">
    ...
    <div class="container mx-auto max-w-[800px]">
      <div>
        <h1 class="mb-1 text-xl font-bold md:px-4">
        ...
        <div v-if="alojamiento && alojamiento.attributes.checkin_time && alojamiento.attributes.checkout_time" class="bg-[#F7F7F7] p-4 mb-5">
          ...
          <ul>
            <li class="flex items-center mb-2">
              ...
              {{ isAlojamiento ? 'Check-In:' : null }}
              <b class="ml-1">Desde las {{ alojamiento.attributes.checkin_time.slice(0, -3) }} hs.</b>
            </li>
            <li class="flex items-center">
              ...
              {{ isAlojamiento ? 'Check-Out:' : null }}
              <b class="ml-1">Hasta las {{ alojamiento.attributes.checkout_time.slice(0, -3) }} hs.</b>
            </li>
          </ul>
        </div>
              ...
              <div class="swiper-slide">
                <article class="bg-[#F7F7F7] p-4 h-full flex flex-col justify-between rounded-[10px]">
                  ...
                  <div class="grid grid-cols-2 items-center">
                    <h5 class="text-sm">
                      Precio <b>{{ data.attributes.price_currency }} ${{ roundNumber(data.attributes.price) }}</b>
                    </h5>
...
export default {
  ...
  computed: {
    isAlojamiento () {
      return this.data.attributes.objeto.type === 'Alojamiento'
    }
  },
  head: {
    title: 'Alojamiento'
